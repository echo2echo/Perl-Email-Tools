...
### I do some test mailings with an address text file that has a few of my own email addresses before you run the script on the "big" list to check for any errors or text changes and to see if it looks good enough to send.  Once it looks good, replace the test file with the unique_sorted_emails.txt or your own production ready file
